...
/**
 * 由用户控制主题色，所以colorPrimary配置仅在初始化时有效
 * 该属性会写入unocss，可通过className配置
 * 配合vscode unocss插件，可以快速查看对应的token属性
 */
 ...
 */
export const antdUnoColor = () => {
  return merge(antdColors(), antdColorToken());
};
